 ...
 * 
 * @param[in] _pts_i        特征点在 cam_i 的归一化平面上的坐标
 * @param[in] _pts_j        特征点在 cam_j 的归一化平面上的坐标
 * @param[in] _velocity_i   特征点在 cam_i 的像素运动速度
 * @param[in] _velocity_j   特征点在 cam_j 的像素运动速度 
 * @param[in] _td_i         cam_i 和 imu_i 之间的时间戳之差
 * @param[in] _td_j         cam_j 和 imu_j 之间的时间戳之差
 * @param[in] _row_i        特征点在 cam_i 的像素坐标y
 * @param[in] _row_j        特征点在 cam_j 的像素坐标y
 */
